        ...
        <div className="min-h-screen">
            ...
            <section className="bg-[url('/images/test-bg-img.jpg')] object-contain text-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Over 60s Health</h1>
                </div>
            </section>
            <div className="px-4 py-12 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {over60s_health_tests.map((test) => (
                        <div
                            key={test.title}
            ...
            <HealthComponent HealthContent={Over60sHealthContent} />
            <TestFeatureSection />
            <HighlightSection />
        </div>
    );
